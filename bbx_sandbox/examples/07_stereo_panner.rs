...
fn create_graph() -> Graph<f32> {
    ...
    let lfo1 = builder.add_lfo(0.017, 25.0, None);
    ...
    let osc2 = builder.add_oscillator(82.4, Waveform::Triangle, None);
    let gain2 = builder.add_gain(-9.0, None);
    let pan2 = builder.add_panner_stereo(0.0);
    let lfo2 = builder.add_lfo(0.023, 45.0, None);
    ...
    let osc3 = builder.add_oscillator(196.0, Waveform::Triangle, None);
    let gain3 = builder.add_gain(-10.0, None);
    let pan3 = builder.add_panner_stereo(0.0);
    let lfo3 = builder.add_lfo(0.031, 55.0, None);
    ...
    let osc4 = builder.add_oscillator(246.9, Waveform::Triangle, None);
    let gain4 = builder.add_gain(-11.0, None);
    let pan4 = builder.add_panner_stereo(0.0);
    let lfo4 = builder.add_lfo(0.041, 65.0, None);
    ...
    let osc5 = builder.add_oscillator(261.6, Waveform::Sawtooth, None);
    let lpf = builder.add_low_pass_filter(900.0, 1.5);
    let filter_lfo = builder.add_lfo(0.019, 400.0, None);
    let gain5 = builder.add_gain(-12.0, None);
    let pan5 = builder.add_panner_stereo(0.0);
    let pan_lfo5 = builder.add_lfo(0.053, 75.0, None);
    ...
    let osc6 = builder.add_oscillator(349.2, Waveform::Sine, None);
    let gain6 = builder.add_gain(-14.0, None);
    let pan6 = builder.add_panner_stereo(0.0);
    let lfo6 = builder.add_lfo(0.067, 85.0, None);
